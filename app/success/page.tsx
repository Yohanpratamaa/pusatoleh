        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-700 mb-2">
              Metode: <span className="font-medium">{order.paymentMethod?.name}</span>
            </p>
            {order.paymentMethod?.accountNumber && (
              <div className="text-sm text-gray-700">
                <p>No. Rekening: <span className="font-medium">{order.paymentMethod.accountNumber}</span></p>
                <p>Atas Nama: <span className="font-medium">{order.paymentMethod.accountName}</span></p>
              </div>
            )}
